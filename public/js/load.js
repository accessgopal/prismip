(function (window, undefined){
	...
	AcceptCookie.prototype = {
		...
		appendCss: function()
		{
			...
			cssCode += "#pjAcceptCookieBar { position: fixed; bottom: 0; left: 0; z-index: 9999; overflow-x: hidden; overflow-y: auto; width: 100%; max-height: 100%; padding: 30px 0; background: #000000; font-family: 'Open Sans', sans-serif; text-align: center; }";
		...
		addCookieBar: function(){
			...
			htmlBar += '<p>We use cookies to ensure that we give you the best experience on our website. <br />By closing this message, you consent to our cookies on this device in accordance with our cookie policy unless you have disabled them. If you wish to read our privacy policy please visit: prismipr.com/privacy-policy</p>';
